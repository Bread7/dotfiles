...
# brew install drawio
# brew install docker docker-buildx docker-clean docker-compose docker-ls docker-squash
...
Kindle requires login to Broadcom web before downloading.
VMWare Fusion requires login to Broadcom web before downloading.
DaVinci Resolve requires login to Broadcom web before downloading.
EOF
