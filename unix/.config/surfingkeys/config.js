...
// api.unmap("<Ctrl-d>");
// api.unmap("<Ctrl-u>");
// api.mapkey('<Ctrl-d>', '#2Scroll a page down', 'Normal.scroll("pageDown")', { repeatIgnore: true });
// api.mapkey('<Ctrl-u>', '#2Scroll a page up', 'Normal.scroll("pageUp")', { repeatIgnore: true });
